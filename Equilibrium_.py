...
cx=[0,150,300,450,600,750,900,1050,1200]
cy=[0,420,420,420,420,420,420,420,420]
...
title = font0.render('Правило рычага, Момент сил',\
    True, 'blue')
font0_2 = pygame.font.SysFont(None, 30)
your_answer=font0_2.render('Ответ внесите \
в прямоугольное окно',True, 'blue')
...
while True:
    ...
    pygame.draw.polygon(screen, 'red', ((qx[1],qy[1]), (qx[2],qy[2]),\
                                        (qx[3],qy[3]),(qx[4],qy[4])))
    for i in range (1,8):
